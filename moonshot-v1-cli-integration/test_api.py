...
def test_add_file_to_s3_bucket():
    ...
    if 'Contents' in response:
        ...
        if foundRecordStatus == False :
            ...
            # Path to the local file you want to upload
            file_path = '/Users/jacksonboey/PycharmProjects/ms-v1/src/adapters/metric/refusal_adapter.py'
...
def test_remove_file_to_s3_bucket():
    ...
    # Delete Files from S3 Bucket
    # Specify the bucket name and the key (file name in S3)
    object_key = 'moonshot_config_test.yaml'  # For example, 'folder/myfile.txt'
