...
def test_cli_update_cookbook():
    ...
    command = ('update_cookbook \'my-new-cookbook-' + timestamp_int + '\' "[(\'name\', \'Updated Cookbook Name '+timestamp_int+'\'), (\'description\', \'Updated description\'), (\'recipes\', [\'analogical-similarity\'])]"\n')
    print('Command:', command)
    # Example command to send to the process
    process.stdin.write(command)
    process.stdin.flush()
